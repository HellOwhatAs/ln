...
fn main() {
    ...
    let sphere2 = OutlineSphere::new(eye, up, Vector::new(0.05, 0.05, 0.05), 0.1);
    ...
    println!("Testing two overlapping spheres:");
    println!("Sphere1 center: (0, 0, 0), radius: 0.1");
    println!("Sphere2 center: (0.05, 0.05, 0.05), radius: 0.1");
    println!("Eye: {:?}", eye);
